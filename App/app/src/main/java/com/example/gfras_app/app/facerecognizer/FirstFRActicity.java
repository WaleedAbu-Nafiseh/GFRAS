...
* objects.
*/
public class FirstFRActicity extends CameraActivity implements OnImageAvailableListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        AlertDialog editDialog = new AlertDialog.Builder(FirstFRActicity.this)
        ...
        button.setOnClickListener(view ->
                new AlertDialog.Builder(FirstFRActicity.this)
